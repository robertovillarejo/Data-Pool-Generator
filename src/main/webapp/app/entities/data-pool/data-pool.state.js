    ...
    function stateConfig($stateProvider) {
        ...
        .state('data-pool', {
            ...
            data: {
                ...
                pageTitle: 'dataPoolGeneratorApp.dataPool.home.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/data-pool/data-pools.html',
        ...
        .state('data-pool-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'dataPoolGeneratorApp.dataPool.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/data-pool/data-pool-detail.html',
        ...
        .state('data-pool-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/data-pool/data-pool-dialog.html',
        ...
        .state('data-pool.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/data-pool/data-pool-delete-dialog.html',
