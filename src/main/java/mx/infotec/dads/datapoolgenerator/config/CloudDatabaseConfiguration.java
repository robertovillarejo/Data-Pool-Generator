package mx.infotec.dads.datapoolgenerator.config;
...
@Configuration
@EnableMongoRepositories("mx.infotec.dads.datapoolgenerator.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("mx.infotec.dads.datapoolgenerator.config.dbmigrations");
